...
\question[6] A particle with mass $m$ and charge $e$ is launched out of a device with a velocity of $v$ m/s into deep space. After a while, the particle enters a magnetic field with a strength of B [into page] at an angle of $45 \degree$ above the horizontal. Please see Figure \ref{fig:q1-1} for a diagram.

\begin{figure}
\centering
\tikzfig{q3}
\caption{Particle and magnetic field} \label{fig:q1-1}
\end{figure}
